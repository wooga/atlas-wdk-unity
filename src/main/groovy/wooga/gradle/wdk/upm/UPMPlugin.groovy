...
class UPMPlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        def extension = UPMExtension.withPublishingConventions(project, publishingExt, EXTENSION_NAME)
    ...
    Provider<? extends List<Publication>> configureUPMProjects(UPMExtension extension,
    ...
    private static PublishingExtension configurePublishingExtension(Project project) {
        ...
        publishing.with {
            ...
            new DslObject(it.repositories).convention.plugins.put(UPMPlugin.canonicalName, upmHandlerConvention)
        }
        return publishing
    }

    private static void configureArtifactory(Project project, UPMExtension upmExtension, Provider<List<Publication>> publications) {
